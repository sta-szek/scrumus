...
Tu krótko opiszę, że warstwa składa się na 
a) REST - jest jedna metoda rest w projekcie dla celow demonstracyjnych, jak latwo dwoma adnotacjami mozna udostepnic ten web service
b) remote ejb, pokaze jak latwo jedna adnotacja mozna udostepnic ejb, tak aby mozna bylo polaczyc sie zdalnie
c) wlasciwa warstwa prezentacji czyli interfejs www + zrzuty wybranych ekranów - najlepiej tworzenia uzytkownika aby pokrylo sie ze schematem wyzej
