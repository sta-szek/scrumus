...
Przedstawiony wyżej listnig tworzy plik WAR oraz dodaje rekurencyjnie do niego pakiety znajdujące się w pakietach: \textit{edu.piotrjonski.scrumus, org.assertj.core, org.mockito, org.obejnesis, org.apache.commons.collections4}. Dodatkowo kopiowane są pliki ustawień bazy danych - \textit{persistence.xml} oraz plik konfiguracji systemu. Wszystko jest wdrażane pod nazwą \textit{test.war}.
